...
public class ApiClient extends ApiClientCustom {
    ...
    private String basePath = "https://api.snyk.io/rest";
    ...
    public String getAPIToken() {
        return ((ApiKeyAuth) this.getAuthentication("APIToken")).getApiKey();
    }

    public void setAPIToken(String apiKey) {
        ((ApiKeyAuth) this.getAuthentication("APIToken")).setApiKey(apiKey);
    }

    public void setAPITokenPrefix(String prefix) {
        ((ApiKeyAuth) this.getAuthentication("APIToken")).setApiKeyPrefix(prefix);
    }
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.snyk.io/rest)

...
import com.konfigthis.client.model.AppResourceAttributes;
...
public class AppData {
  ...
  private AppResourceAttributes attributes;
  ...
  public AppData attributes(AppResourceAttributes attributes) {
  ...
  **/
  ...
  public AppResourceAttributes getAttributes() {
    return attributes;
  }


  public void setAttributes(AppResourceAttributes attributes) {
  ...
  **/
   ...
   * @return the AppData instance itself
   */
  public AppData putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.attributes, appData.attributes) &&
        Objects.equals(this.id, appData.id) &&
        Objects.equals(this.type, appData.type)&&
        Objects.equals(this.additionalProperties, appData.additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppData.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : AppData.openapiRequiredFields) {
        if (jsonObj.get(requiredField) == null) {
          throw new IllegalArgumentException(String.format("The required field `%s` is not found in the JSON string: %s", requiredField, jsonObj.toString()));
        }
      }
      // validate the required field `attributes`
      AppResourceAttributes.validateJsonObject(jsonObj.getAsJsonObject("attributes"));
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<AppData>() {
           ...
           public AppData read(JsonReader in) throws IOException {
             ...
             AppData instance = thisAdapter.fromJsonTree(jsonObj);

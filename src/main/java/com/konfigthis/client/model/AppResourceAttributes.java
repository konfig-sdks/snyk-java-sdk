...
public class AppResourceAttributes {
  ...
  public AppResourceAttributes() {
  }

  public AppResourceAttributes accessTokenTtlSeconds(Double accessTokenTtlSeconds) {
  ...
  public AppResourceAttributes accessTokenTtlSeconds(Integer accessTokenTtlSeconds) {
    if (accessTokenTtlSeconds != null && accessTokenTtlSeconds < 3600) {
      throw new IllegalArgumentException("Invalid value for accessTokenTtlSeconds. Must be greater than or equal to 3600.");
    }
    if (accessTokenTtlSeconds != null && accessTokenTtlSeconds > 86400) {
  ...
  **/
  ...
  public AppResourceAttributes clientId(UUID clientId) {
  ...
  **/
  ...
  @ApiModelProperty(example = "941b423a-e0a0-4a33-a7ca-dd9e9e6bd8cf", value = "The oauth2 client id for the app.")
  ...
  public AppResourceAttributes context(Context context) {
  ...
  **/
  ...
  public AppResourceAttributes grantType(GrantType grantType) {
  ...
  **/
  ...
  public AppResourceAttributes isConfidential(Boolean isConfidential) {
  ...
  **/
  ...
  public AppResourceAttributes isPublic(Boolean isPublic) {
  ...
  **/
  ...
  public AppResourceAttributes name(String name) {
  ...
  **/
  ...
  public AppResourceAttributes orgPublicId(UUID orgPublicId) {
  ...
  **/
  ...
  public AppResourceAttributes redirectUris(List<URI> redirectUris) {
  ...
  public AppResourceAttributes addRedirectUrisItem(URI redirectUrisItem) {
  ...
  **/
  ...
  public AppResourceAttributes scopes(List<String> scopes) {
  ...
  public AppResourceAttributes addScopesItem(String scopesItem) {
  ...
  **/
   ...
   * @return the AppResourceAttributes instance itself
   */
  public AppResourceAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    AppResourceAttributes appResourceAttributes = (AppResourceAttributes) o;
    return Objects.equals(this.accessTokenTtlSeconds, appResourceAttributes.accessTokenTtlSeconds) &&
        Objects.equals(this.clientId, appResourceAttributes.clientId) &&
        Objects.equals(this.context, appResourceAttributes.context) &&
        Objects.equals(this.grantType, appResourceAttributes.grantType) &&
        Objects.equals(this.isConfidential, appResourceAttributes.isConfidential) &&
        Objects.equals(this.isPublic, appResourceAttributes.isPublic) &&
        Objects.equals(this.name, appResourceAttributes.name) &&
        Objects.equals(this.orgPublicId, appResourceAttributes.orgPublicId) &&
        Objects.equals(this.redirectUris, appResourceAttributes.redirectUris) &&
        Objects.equals(this.scopes, appResourceAttributes.scopes)&&
        Objects.equals(this.additionalProperties, appResourceAttributes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(accessTokenTtlSeconds, clientId, context, grantType, isConfidential, isPublic, name, orgPublicId, redirectUris, scopes, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class AppResourceAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to AppResourceAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!AppResourceAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in AppResourceAttributes is not found in the empty JSON string", AppResourceAttributes.openapiRequiredFields.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : AppResourceAttributes.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!AppResourceAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'AppResourceAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<AppResourceAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(AppResourceAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<AppResourceAttributes>() {
           @Override
           public void write(JsonWriter out, AppResourceAttributes value) throws IOException {
           ...
           @Override
           public AppResourceAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             AppResourceAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of AppResourceAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of AppResourceAttributes
  * @throws IOException if the JSON string is invalid with respect to AppResourceAttributes
  */
  public static AppResourceAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, AppResourceAttributes.class);
  }

 /**
  * Convert an instance of AppResourceAttributes to an JSON string
  *
  * @return JSON string
  */

...
public class CollectionMeta {
  ...
  private Double projectsCount;

  public CollectionMeta() {
  }

  public CollectionMeta issuesCriticalCount(Double issuesCriticalCount) {
  ...
  public CollectionMeta issuesCriticalCount(Integer issuesCriticalCount) {
  ...
  **/
  ...
  @ApiModelProperty(example = "10", required = true, value = "The sum of critical severity issues of the collection's projects")
  ...
  public CollectionMeta issuesHighCount(Double issuesHighCount) {
  ...
  public CollectionMeta issuesHighCount(Integer issuesHighCount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "10", required = true, value = "The sum of high severity issues of the collection's projects")
  ...
  public CollectionMeta issuesLowCount(Double issuesLowCount) {
  ...
  public CollectionMeta issuesLowCount(Integer issuesLowCount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "10", required = true, value = "The sum of low severity issues of the collection's projects")
  ...
  public CollectionMeta issuesMediumCount(Double issuesMediumCount) {
  ...
  public CollectionMeta issuesMediumCount(Integer issuesMediumCount) {
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "10", required = true, value = "The sum of medium severity issues of the collection's projects")
  ...
  public CollectionMeta projectsCount(Double projectsCount) {
  ...
  public CollectionMeta projectsCount(Integer projectsCount) {
    
    
    
    
    this.projectsCount = projectsCount.doubleValue();
    return this;
  }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(example = "7", required = true, value = "The amount of projects belonging to this collection")

  public Double getProjectsCount() {
    return projectsCount;
  }


  public void setProjectsCount(Double projectsCount) {
   ...
   * @return the CollectionMeta instance itself
   */
  public CollectionMeta putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.issuesCriticalCount, collectionMeta.issuesCriticalCount) &&
        Objects.equals(this.issuesHighCount, collectionMeta.issuesHighCount) &&
        Objects.equals(this.issuesLowCount, collectionMeta.issuesLowCount) &&
        Objects.equals(this.issuesMediumCount, collectionMeta.issuesMediumCount) &&
        Objects.equals(this.projectsCount, collectionMeta.projectsCount)&&
        Objects.equals(this.additionalProperties, collectionMeta.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(issuesCriticalCount, issuesHighCount, issuesLowCount, issuesMediumCount, projectsCount, additionalProperties);
  }
  ...
  static {
    ...
    openapiFields.add("projects_count");
    ...
    openapiRequiredFields.add("projects_count");
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to CollectionMeta
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CollectionMeta.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
      ...
      for (String requiredField : CollectionMeta.openapiRequiredFields) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<CollectionMeta>() {
           ...
           public CollectionMeta read(JsonReader in) throws IOException {
             ...
             CollectionMeta instance = thisAdapter.fromJsonTree(jsonObj);

...
public class CommonIssueModelVTwoAttributes {
  ...
  private List<CoordinateVTwo> coordinates = null;
 ...
 public enum EffectiveSeverityLevelEnum {
  ...
  private List<CommonIssueModelVTwoAttributesProblemsInner> problems = null;
  ...
  public CommonIssueModelVTwoAttributes() {
  }

  public CommonIssueModelVTwoAttributes title(String title) {
  ...
  **/
  ...
  public CommonIssueModelVTwoAttributes description(String description) {
  ...
  **/
  ...
  public CommonIssueModelVTwoAttributes coordinates(List<CoordinateVTwo> coordinates) {
  ...
  public CommonIssueModelVTwoAttributes addCoordinatesItem(CoordinateVTwo coordinatesItem) {
  ...
  **/
  ...
  public List<CoordinateVTwo> getCoordinates() {
    return coordinates;
  }


  public void setCoordinates(List<CoordinateVTwo> coordinates) {
  ...
  public CommonIssueModelVTwoAttributes createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public CommonIssueModelVTwoAttributes effectiveSeverityLevel(EffectiveSeverityLevelEnum effectiveSeverityLevel) {
  ...
  **/
  ...
  public CommonIssueModelVTwoAttributes problems(List<CommonIssueModelVTwoAttributesProblemsInner> problems) {
  ...
  public CommonIssueModelVTwoAttributes addProblemsItem(CommonIssueModelVTwoAttributesProblemsInner problemsItem) {
  ...
  **/
  ...
  public List<CommonIssueModelVTwoAttributesProblemsInner> getProblems() {
    return problems;
  }


  public void setProblems(List<CommonIssueModelVTwoAttributesProblemsInner> problems) {
  ...
  public CommonIssueModelVTwoAttributes severities(List<Severity> severities) {
  ...
  public CommonIssueModelVTwoAttributes addSeveritiesItem(Severity severitiesItem) {
  ...
  **/
  ...
  public CommonIssueModelVTwoAttributes slots(Slots slots) {
  ...
  **/
  ...
  public CommonIssueModelVTwoAttributes type(String type) {
  ...
  **/
  ...
  public CommonIssueModelVTwoAttributes updatedAt(OffsetDateTime updatedAt) {
  ...
  **/
   ...
   * @return the CommonIssueModelVTwoAttributes instance itself
   */
  public CommonIssueModelVTwoAttributes putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    CommonIssueModelVTwoAttributes commonIssueModelVTwoAttributes = (CommonIssueModelVTwoAttributes) o;
    return Objects.equals(this.title, commonIssueModelVTwoAttributes.title) &&
        Objects.equals(this.description, commonIssueModelVTwoAttributes.description) &&
        Objects.equals(this.coordinates, commonIssueModelVTwoAttributes.coordinates) &&
        Objects.equals(this.createdAt, commonIssueModelVTwoAttributes.createdAt) &&
        Objects.equals(this.effectiveSeverityLevel, commonIssueModelVTwoAttributes.effectiveSeverityLevel) &&
        Objects.equals(this.problems, commonIssueModelVTwoAttributes.problems) &&
        Objects.equals(this.severities, commonIssueModelVTwoAttributes.severities) &&
        Objects.equals(this.slots, commonIssueModelVTwoAttributes.slots) &&
        Objects.equals(this.type, commonIssueModelVTwoAttributes.type) &&
        Objects.equals(this.updatedAt, commonIssueModelVTwoAttributes.updatedAt)&&
        Objects.equals(this.additionalProperties, commonIssueModelVTwoAttributes.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(title, description, coordinates, createdAt, effectiveSeverityLevel, problems, severities, slots, type, updatedAt, additionalProperties);
  }

  @Override
  public String toString() {
    StringBuilder sb = new StringBuilder();
    sb.append("class CommonIssueModelVTwoAttributes {\n");
  ...
  * @throws IOException if the JSON Object is invalid with respect to CommonIssueModelVTwoAttributes
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!CommonIssueModelVTwoAttributes.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in CommonIssueModelVTwoAttributes is not found in the empty JSON string", CommonIssueModelVTwoAttributes.openapiRequiredFields.toString()));
        }
      }
      ...
      if (jsonObj.get("coordinates") != null && !jsonObj.get("coordinates").isJsonNull()) {
        ...
        if (jsonArraycoordinates != null) {
          ...
          for (int i = 0; i < jsonArraycoordinates.size(); i++) {
            CoordinateVTwo.validateJsonObject(jsonArraycoordinates.get(i).getAsJsonObject());
          };
        }
      }
      ...
      if (jsonObj.get("problems") != null && !jsonObj.get("problems").isJsonNull()) {
        ...
        if (jsonArrayproblems != null) {
          ...
          for (int i = 0; i < jsonArrayproblems.size(); i++) {
            CommonIssueModelVTwoAttributesProblemsInner.validateJsonObject(jsonArrayproblems.get(i).getAsJsonObject());
          };
        }
      }
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!CommonIssueModelVTwoAttributes.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'CommonIssueModelVTwoAttributes' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<CommonIssueModelVTwoAttributes> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(CommonIssueModelVTwoAttributes.class));

       return (TypeAdapter<T>) new TypeAdapter<CommonIssueModelVTwoAttributes>() {
           @Override
           public void write(JsonWriter out, CommonIssueModelVTwoAttributes value) throws IOException {
           ...
           @Override
           public CommonIssueModelVTwoAttributes read(JsonReader in) throws IOException {
             JsonObject jsonObj = elementAdapter.read(in).getAsJsonObject();
             validateJsonObject(jsonObj);
             // store additional fields in the deserialized instance
             CommonIssueModelVTwoAttributes instance = thisAdapter.fromJsonTree(jsonObj);
 ...
 /**
  * Create an instance of CommonIssueModelVTwoAttributes given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of CommonIssueModelVTwoAttributes
  * @throws IOException if the JSON string is invalid with respect to CommonIssueModelVTwoAttributes
  */
  public static CommonIssueModelVTwoAttributes fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, CommonIssueModelVTwoAttributes.class);
  }

 /**
  * Convert an instance of CommonIssueModelVTwoAttributes to an JSON string
  *
  * @return JSON string
  */

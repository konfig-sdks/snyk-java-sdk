...
public class Dependency {
  ...
  public Dependency packageName(String packageName) {
    
    
    if (packageName != null && packageName.length() < 1) {
      throw new IllegalArgumentException("Invalid value for packageName. Length must be greater than or equal to 1.");
    }
  ...
  **/
  ...
  @ApiModelProperty(required = true, value = "The package name the issue was found in")
  ...
  public Dependency packageVersion(String packageVersion) {
    
    
    if (packageVersion != null && packageVersion.length() < 1) {
      throw new IllegalArgumentException("Invalid value for packageVersion. Length must be greater than or equal to 1.");
    }
  ...
  **/
  @javax.annotation.Nonnull
  @ApiModelProperty(required = true, value = "The package version the issue was found in")
   ...
   * @return the Dependency instance itself
   */
  public Dependency putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.packageName, dependency.packageName) &&
        Objects.equals(this.packageVersion, dependency.packageVersion)&&
        Objects.equals(this.additionalProperties, dependency.additionalProperties);
  }

  @Override
  public int hashCode() {
    return Objects.hash(packageName, packageVersion, additionalProperties);
  }
  ...
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      ...
      if (!jsonObj.get("package_version").isJsonPrimitive()) {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<Dependency>() {
           ...
           public Dependency read(JsonReader in) throws IOException {
             ...
             Dependency instance = thisAdapter.fromJsonTree(jsonObj);

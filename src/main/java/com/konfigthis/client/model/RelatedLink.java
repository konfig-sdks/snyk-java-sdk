...
public class RelatedLink {
  ...
  public RelatedLink related(Object related) {
  ...
  **/
   ...
   * @return the RelatedLink instance itself
   */
  public RelatedLink putAdditionalProperty(String key, Object value) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.related, relatedLink.related)&&
        Objects.equals(this.additionalProperties, relatedLink.additionalProperties);
  }
  ...
  * @throws IOException if the JSON Object is invalid with respect to RelatedLink
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RelatedLink.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       ...
       return (TypeAdapter<T>) new TypeAdapter<RelatedLink>() {
           ...
           public RelatedLink read(JsonReader in) throws IOException {
             ...
             RelatedLink instance = thisAdapter.fromJsonTree(jsonObj);
